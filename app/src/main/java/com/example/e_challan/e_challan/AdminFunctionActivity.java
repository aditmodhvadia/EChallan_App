...
public class AdminFunctionActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.admin_function, menu);
        return true;
    }
    ...
    private void displayFragment(int id) {
        ...
        if (id == R.id.nav_add_officer) {
            ...
            fragment = new AdminAddOfficerFragment();

        } else if (id == R.id.nav_update_officer_details) {
            fragment = new AdminUpdateOfficerFragment();
        ...
        if (fragment != null) {
            ...
            ft.replace(R.id.content_admin_function_display, fragment);
            ft.commit();
        }
